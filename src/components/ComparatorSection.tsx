      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-6">
            Comparador <span className="bg-gradient-to-r from-pink-400 to-cyan-400 bg-clip-text text-transparent">inteligente</span> de tarifas
          </h2>
          <p className="text-lg md:text-xl lg:text-2xl text-gray-300 max-w-4xl mx-auto font-medium">
            Encuentra la mejor tarifa personalizada con <span className="font-black text-pink-400">inteligencia artificial</span> según tu consumo real en <span className="font-black text-cyan-400">tiempo real</span>
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                  ...
                  <button
                    ...
                    className={`p-3 lg:p-4 rounded-xl lg:rounded-2xl font-bold transition-all duration-300 flex items-center justify-center space-x-2 lg:space-x-3 transform hover:scale-105 ${
                      activeFilter === filter.id
                        ? 'bg-gradient-to-r from-pink-500 to-cyan-500 text-white shadow-2xl'
                        : 'bg-slate-700 text-gray-300 hover:bg-slate-600 shadow-lg border-2 border-pink-400/20 hover:border-pink-400/40'
                    }`}
                  >
            ...
            <div>
              ...
              <select
                ...
                className="w-full p-3 lg:p-4 rounded-xl lg:rounded-2xl border-2 border-pink-400/30 focus:border-pink-400 focus:ring-4 focus:ring-pink-400 focus:ring-opacity-20 bg-slate-700 text-white shadow-lg font-semibold text-base lg:text-lg"
              >
        ...
        <div className="text-center mt-8 lg:mt-12">
          <p className="text-gray-300 mb-4 lg:mb-6 text-lg lg:text-xl font-semibold">¿Quieres ver más opciones personalizadas para tu consumo?</p>
          <button
            onClick={onGoToSubirFactura}
            className="bg-gradient-to-r from-pink-500 to-cyan-500 text-white px-8 lg:px-12 py-4 lg:py-6 rounded-2xl lg:rounded-3xl font-black text-lg lg:text-2xl hover:from-pink-400 hover:to-cyan-400 transition-all duration-500 transform hover:scale-105 lg:hover:scale-110 shadow-xl lg:shadow-2xl hover:shadow-pink-500/50 border-2 lg:border-4 border-white/20"
          >
