...
const Header: React.FC<HeaderProps> = ({ onChatOpen, onPageChange, onGoToSubirFactura }) => {
  ...
  return (
    <header className="fixed top-0 w-full bg-slate-900/95 backdrop-blur-xl border-b border-pink-400/20 z-50 shadow-lg shadow-black/30">
      {/* Background Effects */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden hidden md:block">
        <div className="absolute top-0 left-0 w-32 h-32 bg-pink-500/10 rounded-full blur-xl"></div>
        <div className="absolute top-0 right-0 w-32 h-32 bg-cyan-500/10 rounded-full blur-xl"></div>
      </div>
        ...
        <div className="flex justify-between items-center h-16 md:h-20 relative">
          <div className="flex items-center space-x-2 md:space-x-4 group">
            ...
            <div className="flex flex-col">
              <span className="text-2xl md:text-4xl font-black bg-gradient-to-r from-pink-400 via-white to-cyan-400 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-500">
                LUZIA
              </span>
          ...
          <button
            ...
            className="md:hidden p-2 rounded-lg bg-gradient-to-r from-pink-500 to-cyan-500 text-white"
          >
          ...
          <nav className="hidden md:flex space-x-6 lg:space-x-10 relative">
            <a 
              ...
              className="relative text-gray-300 hover:text-pink-400 font-black text-sm lg:text-lg transition-all duration-300 transform hover:scale-110 group cursor-pointer"
            >
              Cómo funciona
              <div className="absolute -bottom-2 left-0 w-0 h-1 bg-gradient-to-r from-pink-400 to-cyan-400 group-hover:w-full transition-all duration-300 rounded-full"></div>
            </a>
            <a 
              href="#comparador" 
              onClick={(e) => {
          ...
          <button
            ...
            className="hidden md:block relative bg-gradient-to-r from-pink-500 to-cyan-500 text-white px-4 lg:px-10 py-2 lg:py-4 rounded-xl lg:rounded-2xl font-black text-sm lg:text-xl hover:from-pink-400 hover:to-cyan-400 transition-all duration-500 transform hover:scale-110 shadow-lg lg:shadow-2xl hover:shadow-pink-500/50 border border-white/20 lg:border-2 group overflow-hidden"
          >
          ...
          <div className="md:hidden fixed top-16 left-0 right-0 bg-slate-900 border-b border-pink-400/20 shadow-2xl shadow-black/50 z-50">
            <nav className="px-4 py-6 space-y-4">
              <a 
                ...
                className="block text-gray-300 hover:text-pink-400 font-bold text-lg py-2 border-b border-pink-400/20"
              >
                Cómo funciona
              </a>
              <a 
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-pink-500 to-cyan-500 text-white px-6 py-4 rounded-xl font-black text-lg shadow-lg flex items-center justify-center space-x-3"
              >
