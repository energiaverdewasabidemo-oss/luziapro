    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-6 md:py-12 max-w-6xl relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-4 md:gap-8 max-w-7xl mx-auto">
            <div className="group relative">
              ...
              <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl md:rounded-3xl p-5 md:p-8 border-2 border-pink-400/20 group-hover:border-pink-400/60 transition-all duration-300 h-full flex flex-col">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-pink-400/20">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-400 to-cyan-400 flex items-center justify-center text-white font-black text-xl shadow-lg shadow-pink-400/30">M</div>
                  <div>
            ...
            <div className="group relative md:-translate-y-4">
              ...
              <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl md:rounded-3xl p-5 md:p-8 border-2 border-pink-400/60 group-hover:border-pink-400 transition-all duration-300 h-full flex flex-col shadow-2xl shadow-pink-400/20">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-pink-400/20">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-400 to-cyan-400 flex items-center justify-center text-white font-black text-xl shadow-lg shadow-pink-400/30">C</div>
                  <div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl md:rounded-3xl p-5 md:p-8 border-2 border-pink-400/20 group-hover:border-pink-400/60 transition-all duration-300 h-full flex flex-col">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-pink-400/20">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-pink-400 to-cyan-400 flex items-center justify-center text-white font-black text-xl shadow-lg shadow-pink-400/30">A</div>
                  <div>
            ...
            <div className="group bg-slate-900/50 rounded-xl md:rounded-2xl p-5 md:p-8 border-2 border-pink-400/20 hover:border-pink-400/60 transition-all duration-300">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a href="tel:+34621508300" className="text-pink-400 font-semibold hover:text-pink-500 transition-colors">+34 621 50 83 00</a>
                </div>
                <div className="flex items-center gap-3">
                  <span className="text-gray-500">📧</span>
                  <a href="mailto:info@luzia.pro" className="text-pink-400 font-semibold hover:text-pink-500 transition-colors">info@luzia.pro</a>
                </div>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-br from-yellow-500/20 to-orange-500/20 border-2 border-yellow-500/30 rounded-2xl md:rounded-3xl p-5 md:p-12 mb-8 md:mb-16">
          ...
          <p className="text-lg md:text-2xl font-bold text-pink-400 text-center">Es ahora.</p>
        </div>
        ...
        <div className="mt-8 md:mt-16 text-center">
          <div className="inline-flex items-center gap-3 md:gap-4 bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl md:rounded-2xl p-4 md:p-6 shadow-lg border border-pink-400/30">
            ...
            <div className="text-left">
              <p className="font-semibold text-white">Llevamos años analizando facturas energéticas</p>
              <p className="text-gray-400">Sabemos dónde están los errores y cómo optimizar cada contrato</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="bg-slate-900/80 rounded-xl md:rounded-2xl p-5 md:p-8 mb-6 md:mb-10 border border-gray-700/50">
            ...
            <div className="text-gray-400 text-sm leading-relaxed space-y-3">
              <p>Este sitio web no forma parte de Facebook, Meta Platforms Inc., ni está respaldado por Facebook o Meta. FACEBOOK y META son marcas registradas de Meta Platforms, Inc.</p>
              <p>Esta página web utiliza publicidad de pago en plataformas de Meta (Facebook e Instagram) para promocionar nuestros servicios de asesoría energética. Los resultados mostrados son ejemplos reales de clientes, pero los resultados individuales pueden variar según cada caso particular.</p>
              <p className="text-xs text-gray-500">Descargo de responsabilidad: No garantizamos ahorros específicos. El ahorro real dependerá de tu contrato actual, consumo y las tarifas disponibles en el momento del análisis.</p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            <div>
              ...
              <div className="space-y-2">
                <button onClick={() => onPageChange?.('privacy')} className="block text-gray-400 hover:text-pink-400 transition-colors text-sm text-left">Política de Privacidad</button>
                <button onClick={() => onPageChange?.('legal')} className="block text-gray-400 hover:text-pink-400 transition-colors text-sm text-left">Aviso Legal</button>
                <button onClick={() => onPageChange?.('terms')} className="block text-gray-400 hover:text-pink-400 transition-colors text-sm text-left">Términos y Condiciones</button>
                <button onClick={() => onPageChange?.('cookies')} className="block text-gray-400 hover:text-pink-400 transition-colors text-sm text-left">Política de Cookies</button>
              </div>
            </div>
            <div>
